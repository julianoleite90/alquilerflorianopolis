...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/favicon-im.png', type: 'image/png', sizes: '32x32' },
      { url: '/favicon-im.png', type: 'image/png', sizes: '192x192' },
      { url: '/favicon-im.png', type: 'image/png', sizes: '512x512' },
    ],
    apple: [
      { url: '/favicon-im.png', sizes: '180x180', type: 'image/png' },
    ],
    shortcut: [
      { url: '/favicon-im.png', type: 'image/png' },
    ],
  },
}
